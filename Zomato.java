...
public static double getzomatoMenunName(String foodName){
    ...
    System.out.println("getzomatoMenunName started");
	 ...
	 if(foodName == "Chicken Fajitas")return  ZomatoPrice  = 300.87 ;
   
  
   else if(foodName == "Beef Tacos")return ZomatoPrice  = 2000.89;
   
  
  else if(foodName == "Shrimp Scampi") return  ZomatoPrice = 539.0 ;
   
  
  else if(foodName == "Lamb Kofta")return  ZomatoPrice = 4969.09 ;
  
  
  else if(foodName == "Shrimp Scampi")return  ZomatoPrice = 3673.98 ;

  
  else if(foodName == "Beef Tacos") return  ZomatoPrice = 573.98;
  
  
  else if(foodName == "Shrimp Scampi")return ZomatoPrice =589.98 ;
  
  
  else if(foodName == "Fish Fry") return ZomatoPrice = 4492.09 ;
  
  
  else if(foodName == "Crab Cakes") return ZomatoPrice = 989.78;
  
  
  else if(foodName == "Chicken Fajitas")return ZomatoPrice = 3773.98;
  
  
  else if(foodName == "Vegetable Quinoa Bowl") return  ZomatoPrice = 4456.45;
  
  
  else if(foodName == "Artichoke Dip") return ZomatoPrice = 3347.56 ;
  
  
  else if(foodName == "Grilled Portobello Mushrooms") return  ZomatoPrice = 4399.34 ;
  
  
  else if(foodName == "Roasted Vegetable Wrap")return ZomatoPrice = 4993.0;
 
  
  else if(foodName == "Lentil Soup") return ZomatoPrice = 3299.0;
  
  else if(foodName == "Vegetable Spring Rolls")return ZomatoPrice  = 2104.8 ;
   
   else if(foodName == "Tofu Skewers")return ZomatoPrice  = 1234.89 ;
   
   else if(foodName == "Quiche Lorrain")return  ZomatoPrice  = 156.89  ;
   
   else if(foodName == "Stuffed Bell Peppers")return  ZomatoPrice  = 4356.89 ;
   
   else if(foodName == "Egg plant Parmesan")return ZomatoPrice  = 2303.89  ;
  ...
  System.out.println("get zomatoMenunName Ended");
  return ZomatoPrice ;
  }
